...
// ((#prevTherapyIsGood && !#isPrevTherapyCheck) && @calcFunc.any(#selVarIds, {212L, 516L})) || (#selVarIds.contains(212L) && (((#sbp >= 130 && #sbp < 140 && #dbp >= 85 && #dbp < 90) && (#score >= #scoreHighLowerBound || #risk==#riskHigh || #risk==#riskVHigh || #risk==#riskExtreme)) || (#sbp < 150 && #dbp < 90 && #score < #scoreMedLowerBound && #risk==#riskLow) || (#grade >= 2 && #age >= 80))) || #isPrevTherapyCheck
/*
(
    (#prevTherapyIsGood && !#isPrevTherapyCheck) &&
    @calcFunc.any(#selVarIds, {212L, 516L})
) ||
(
    #selVarIds.contains(212L) &&
    (
        (
            (#sbp >= 130 && #sbp < 140 && #dbp >= 85 && #dbp < 90) &&
            (#score >= #scoreHighLowerBound || #risk==#riskHigh || #risk==#riskVHigh || #risk==#riskExtreme)
        ) ||
        (#sbp < 150 && #dbp < 90 && #score < #scoreMedLowerBound && #risk==#riskLow) ||
        (#grade >= 2 && #age >= 80)
    )
) ||
#isPrevTherapyCheck
*/
            or("моно") {
                and {
                    this+cond3
                    p("пред.терапия = нет/моно", "@calcFunc.any(#selVarIds, {212L, 516L})")
                }
